<script>
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                if(r.sales_empty) {
                    ...
                    $('#modalSummary #wrapper_quantity').addClass('d-none');
                    $('#modalSummary .quantity').removeClass('d-none');
                    ...
                    $('#modalSummary #wrapper_quantity').removeClass('d-none');
                    $('#modalSummary .quantity').addClass('d-none');
                    $('#modalSummary #wrapper_quantity').html(r.html_quantity);
                }
    ...
    $('body').on('click', '.download', function()
    {
        ...
        let id              = $(this).data('id');
        base_url            = "{{ url('/') }}",
        url_print           = `${base_url}/download-resumen-cash/${id}`;
        window.open(url_print);
    });
</script>