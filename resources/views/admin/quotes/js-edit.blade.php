                ...
                html__new += `<tr id="tr__product__${producto.id}">
                                                ...
                                                <td class="text-right">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-text btn-down" style="cursor: pointer;" data-id="${producto.id}" data-cantidad="1" data-precio="${parseFloat(producto.precio_venta).toFixed(2)}" data-idalmacen="${producto.idalmacen}"><i class="ti ti-minus me-sm-1"></i></span>
                                                        <input type="text" data-id="${producto.id}" class="quantity-counter text-center form-control" value="1" name="input-cantidad">
                                                        <span class="input-group-text btn-up" style="cursor: pointer;" data-id="${producto.id}" data-cantidad="1" data-precio="${parseFloat(producto.precio_venta).toFixed(2)}" data-idalmacen="${producto.idalmacen}"><i class="ti ti-plus me-sm-1"></i></span>
                                                    </div>
                                                </td>
                                                <td class="text-center"><input type="text" class="form-control form-control-sm text-center" value="${parseFloat(producto.precio_venta).toFixed(2)}" data-cantidad="'1" data-id="${producto.id}" data-codigo_igv="${producto.codigo_igv}" data-impuesto="${producto.impuesto}"  data-idalmacen="${producto.idalmacen}" name="input-precio"></td>
