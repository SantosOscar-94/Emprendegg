                                            ...
                                            <tr id="tr__product__{{ $item['idproducto'] }}">
                                                ...
                                                <td class="text-right">
                                                    <div class="input-group input-group-sm">
                                                        <span class="input-group-text btn-down" style="cursor: pointer;" data-id="{{ $item["idproducto"] }}" data-cantidad="{{ $item["cantidad"] }}" data-precio="{{ $item["precio_unitario"] }}" data-idalmacen="{{ $item["idalmacen"] }}"><i class="ti ti-minus me-sm-1"></i></span>
                                                        ...
                                                        <span class="input-group-text btn-up" style="cursor: pointer;" data-id="{{ $item["idproducto"] }}" data-cantidad="{{ $item["cantidad"] }}" data-precio="{{ $item["precio_unitario"] }}" data-idalmacen="{{ $item["idalmacen"] }}"><i class="ti ti-plus me-sm-1"></i></span>
                                                    </div>
                                                </td>
                                                <td class="text-center"><input type="text" class="form-control form-control-sm text-center" value="{{ number_format($item["precio_unitario"], 2, ".", "") }}" data-cantidad="'{{ $item["cantidad"] }}" data-id="{{ $item["idproducto"] }}" data-codigo_igv="{{ $item['codigo_igv'] }}" data-impuesto="{{ $item['impuesto'] }}" data-idalmacen="{{ $item["idalmacen"] }}" name="input-precio"></td>
