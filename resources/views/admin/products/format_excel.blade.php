                ...
                <tbody>
                    @foreach ($productos as $index => $item)
                        <tr>
                            ...
                            <td style="border: 1px solid #dee2e6; text-align: center;" data-format="0.00">{{ $item["precio_compra"] }}</td>
                            <td style="border: 1px solid #dee2e6; text-align: center;" data-format="0.00">{{ $item["precio_venta"] }}</td>
                            <td style="border: 1px solid #dee2e6; text-align: center;">{{ $item["stocks"] }}</td>
