  ...
  <div id="layout-content" class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <div class="layout-page" style="padding-left: 0px;">
        <!-- Navbar -->
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar" style="left: 0px; width: calc(100% - 0rem); max-width: 100%;">
            ...
            <div class="mb-xl-0 mb-0">
              <div class="d-flex svg-illustration mb-0 gap-2 align-items-center" style="justify-content: flex-end;">
                <div class="app-brand-logo demo">
                  <img src="{{ asset('assets/img/icons/icon-login.svg') }}" alt="" class="img-fluid">
                </div>
