...
## Cuentas
Route::get('/cuentas'                    , [CuentasController::class, 'index'])->name('admin.cuentas')->middleware('auth');
...
## Warehouse
Route::get('/warehouses'                    , [WarehouseController::class, 'index'])->name('admin.warehouses')->middleware('auth');
...
## Transfer Order
Route::get('/transfer-orders'               , [TransferOrderController::class, 'index'])->name('admin.transfer_orders')->middleware('auth');
